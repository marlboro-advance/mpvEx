 ...
 * Each preset defines specific values for brightness, saturation, contrast, gamma, and hue.
 */
enum class FilterPreset(
  ...
  VIVID(
    displayName = "Vivid",
    description = "Enhanced colors for vibrant visuals",
    brightness = 5,
    saturation = 25,
    contrast = 15,
    gamma = 0,
  ...
  NEON_POP(
    ...
    description = "Vibrant neon-like colors",
    brightness = 5,
    saturation = 40,
    contrast = 20,
    gamma = 0,
...
enum class VideoFilters(
  ...
  SHARPNESS(
    R.string.player_sheets_filters_sharpness,
    { it.sharpnessFilter },
    "sharpen",
  ),
}

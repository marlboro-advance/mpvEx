...
@Serializable
object UpscaleFilterScreen : Screen {
  ...
  override fun Content() {
    ...
    val videoScaleParam2 by preferences.videoScaleParam2.collectAsState()
      ...
      Column(
        ...
        PreferenceCard {
          Column(
            ...
            Text(
              text = "Control how video frames are resampled when upscaling to a larger size",
            ...
            FlowRow(
              ...
              commonScalers.forEach { sc ->
                FilterChip(
                  selected = videoScale == sc,
                  onClick = {
                    preferences.videoScale.set(sc)
                  },
            ...
            FlowRow(
              ...
              OutlinedTextField(
                value = videoScaleParam1,
                onValueChange = { preferences.videoScaleParam1.set(it) },
              ...
              OutlinedTextField(
                value = videoScaleParam2,
                onValueChange = { preferences.videoScaleParam2.set(it) },
            ...
            Text(
              text =
                "Current: ${videoScale.displayName}" +
                  if (videoScaleParam1.isNotBlank()) " (p1: $videoScaleParam1)" else "" +
                  if (videoScaleParam2.isNotBlank()) " (p2: $videoScaleParam2)" else "",
              style = MaterialTheme.typography.bodySmall,
              color = MaterialTheme.colorScheme.primary,
            )
          }

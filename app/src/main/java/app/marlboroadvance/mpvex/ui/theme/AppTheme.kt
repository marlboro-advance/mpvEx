...
enum class AppTheme(
    ...
    Catppuccin(
        ...
        secondaryLight = Color(0xFFEA76CB),
        secondaryDark = Color(0xFFF5C2E7),
        tertiaryLight = Color(0xFF7287FD),
        tertiaryDark = Color(0xFFB4BEFE),
    ...
    Gruvbox(
        ...
        secondaryLight = Color(0xFFD79921),
        secondaryDark = Color(0xFFFABD2F),
        tertiaryLight = Color(0xFF689D6A),
        tertiaryDark = Color(0xFF8EC07C),
        backgroundLight = Color(0xFFFBF1C7),
        backgroundDark = Color(0xFF282828),
    ),
    Kanagawa(
        titleRes = R.string.theme_kanagawa,
        primaryLight = Color(0xFFC84053),
        primaryDark = Color(0xFF98BB6C),
        secondaryLight = Color(0xFF54546D),
        secondaryDark = Color(0xFFDCD7BA),
        tertiaryLight = Color(0xFF6A9589),
        tertiaryDark = Color(0xFF7E9CD8),
    ...
    TokyoNight(
        ...
        primaryLight = Color(0xFF34548A),
        secondaryLight = Color(0xFF8C4351),
        tertiaryLight = Color(0xFF2E7DE9),
        backgroundLight = Color(0xFFE1E2E7),
        primaryDark = Color(0xFF7AA2F7),
        secondaryDark = Color(0xFFBB9AF7),
        tertiaryDark = Color(0xFF7DCFFF),

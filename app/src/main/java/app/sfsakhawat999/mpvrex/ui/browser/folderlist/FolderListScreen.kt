package app.sfsakhawat999.mpvrex.ui.browser.folderlist
...
import app.sfsakhawat999.mpvrex.domain.media.model.VideoFolder
import app.sfsakhawat999.mpvrex.preferences.BrowserPreferences
import app.sfsakhawat999.mpvrex.preferences.FolderSortType
import app.sfsakhawat999.mpvrex.preferences.SortOrder
import app.sfsakhawat999.mpvrex.preferences.preference.collectAsState
import app.sfsakhawat999.mpvrex.presentation.Screen
import app.sfsakhawat999.mpvrex.presentation.components.pullrefresh.PullRefreshBox
import app.sfsakhawat999.mpvrex.repository.VideoRepository
import app.sfsakhawat999.mpvrex.ui.browser.cards.FolderCard
import app.sfsakhawat999.mpvrex.ui.browser.components.BrowserTopBar
import app.sfsakhawat999.mpvrex.ui.browser.dialogs.DeleteConfirmationDialog
import app.sfsakhawat999.mpvrex.ui.browser.dialogs.SortDialog
import app.sfsakhawat999.mpvrex.ui.browser.fab.MediaActionFab
import app.sfsakhawat999.mpvrex.ui.browser.selection.rememberSelectionManager
import app.sfsakhawat999.mpvrex.ui.browser.sheets.PlayLinkSheet
import app.sfsakhawat999.mpvrex.ui.browser.states.EmptyState
import app.sfsakhawat999.mpvrex.ui.browser.states.PermissionDeniedState
import app.sfsakhawat999.mpvrex.ui.browser.videolist.VideoListScreen
import app.sfsakhawat999.mpvrex.ui.preferences.PreferencesScreen
import app.sfsakhawat999.mpvrex.ui.utils.LocalBackStack
import app.sfsakhawat999.mpvrex.utils.media.MediaUtils
import app.sfsakhawat999.mpvrex.utils.permission.PermissionUtils
import app.sfsakhawat999.mpvrex.utils.sort.SortUtils
...
object FolderListScreen : Screen {
  ...
  override fun Content() {
    ...
    LaunchedEffect(Unit) {
      hasRecentlyPlayed =
        app.sfsakhawat999.mpvrex.utils.history.RecentlyPlayedOps
          .hasRecentlyPlayed()
    }
    ...
    Scaffold(
      topBar = {
        BrowserTopBar(
          title = stringResource(app.sfsakhawat999.mpvrex.R.string.app_name),
            ...
            coroutineScope.launch {
              ...
              if (allVideos.isNotEmpty()) {
                if (allVideos.size == 1) {
                  ...
                  intent.setClass(context, app.sfsakhawat999.mpvrex.ui.player.PlayerActivity::class.java)
...
private fun FolderListContent(
  ...
  selectionManager: app.sfsakhawat999.mpvrex.ui.browser.selection.SelectionManager<VideoFolder, String>,

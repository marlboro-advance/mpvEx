...
package app.sfsakhawat999.mpvrex.ui.browser.states
...
fun PermissionDeniedState(
    ...
    Column(
      ...
      Card(
        ...
        Column(
          ...
          Text(
            text = "mpvRex requires \"All file access\" permission to discover media and subtitles on your device due to a change in security policy in Android 11 and later versions.",
  ...
  if (showExplanationDialog) {
    ...
    val githubUrl = "https://github.com/marlboro-advance/mpvRex"
